var url=rootPath+"/approve/getmaterialapplyapprove",gridQryUrl=url+"/dataGrid.json",custParame=SYSTEM.custParame,typeList=custParame.typeList,
approve_status=["未提交","待审核","通过","拒绝"];
var model = avalon.define({$id:'view',
	query:{getmaterial_no:""},
	parameList:typeList,
	init:function() {
		this.loadGrid();
		this.addEvent();
