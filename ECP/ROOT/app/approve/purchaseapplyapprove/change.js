...
var model = avalon.define({
	...
	data:{id:"",purchase_no:'',is_deleted:0,purchase_name:"",create_time:"",purchase_staff_id:"",approve_status:"",comment:"",company_id:"",billsn:"自动生成",creater_id:"",
			customer_id:"",total_amount:0,total_money:0,
			contacts_name:"",contacts_id:"",customer_id:"",customer_name:"",productlistlength:1,rebate:0,rebate_amt:0,order_amt:0,
			productlist:[{amount:0,description: "",id: "",material_data_id: "",material_data_no:"",model_number:"",unit:"",material_data_name: "",purchase_price:0,total_money:0}]},
	total_amount:0,
	total_money:0,
	userList:[],
    qryHead:function(v){
    ...
    addRow:function(){
    	model.data.productlist.push({material_data_id:'',material_data_name:'',material_data_no:'',model_number:'',description:"",unit:"",total_money:"",purchase_price:"",amount:""});
    },//增加商品行;
...
function postData(){
	...
	alert(model.data.productlist[0].material_data_id);
