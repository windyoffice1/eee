...
var THISPAGE = {
	...
	initDom : function() {
		...
		if(id!=undefined&&id!=''&&id!='undefined'){
			Public.ajaxPost(rootPath+"/basicdata/parame/qryOp.json",{id:id}, function(json){
				if(json.status==200){
...
function postData(){
	...
	Public.ajaxPost(rootPath+"/basicdata/parame/save.json",model.data.$model, function(t) {
		if (200 == t.status) {
