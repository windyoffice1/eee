...
var THISPAGE = {
	...
	initDom : function() {
		...
		if(id!=undefined&&id!=''&&id!='undefined'){
			Public.ajaxPost(rootPath+"/crm/custMemorialday/qryOp.json",{id:id}, function(json){
...
function postData(){
	var e = "add" == oper ? "新增纪念日记录" : "修改纪念日记录";
	Public.ajaxPost(rootPath+"/crm/custMemorialday/save.json",model.data.$model
			, function(t) {
		if (200 == t.status) {
