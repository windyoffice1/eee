var url=rootPath+"/inventorymanager/inventorychildwarehouse",gridQryUrl=url+"/dataGrid.json",custParame=SYSTEM.custParame,parameList=custParame.typeList;
var model = avalon.define({$id:'view',
	query:{material_type_id:"",material_broad_id:"",model_number:"",material_data_name:"",child_warehouse_id:""},
/*   	qry:function(type){
		model.query.wareshouseType=type;
		model.reloadData();
	},*/
	materialBroadList:[],
	...
	qryChildWarehouse:function(){
		Public.ajaxPost(rootPath+"/basicdata/childwarehouse/dataGrid.json", {"rows":999999}, function(t) {
			if (t && 200 == t.status) {
	...
	resetQry:function(){
		model.query={material_type_id:"",material_broad_id:"",model_number:"",material_data_name:"",child_warehouse_id:""};
		model.reloadData();
	},
	loadGrid:function() {
