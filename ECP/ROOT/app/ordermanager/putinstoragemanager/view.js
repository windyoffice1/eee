...
var model = avalon.define({
	...
	data:{id:"",putinstorage_name:'',since_purchase_apply_id:0,since_purchase_apply_name:"",create_time:"",create_user_id:"",create_user_name:"",putinstorage_status:"",comment:"",
			company_id:"",customer_name:"",putinstorage_date:"",real_putinstorage_date:"",putinstorage_comment:"",
			...
			productlist:[{id:"",putinstorage_id: "",material_data_id: "",amount:0,purchase_price:0,total_money:0,model_number:"",unit:"",material_data_name: "",
				target_price:0,plan_putinstorage_total_money:0,material_data_no:"",unit:"",putinstorage_comment:"",putinstorage_warehouse_id:"",putinstorage_warehouse_name:"",
				invoice_number:"",putinstorage_date:""}]},
	total_amount:0,
	total_money:0,
	userList:[],
	init:function(){
		...
		if(id!=undefined&&id!=''&&id!='undefined'){
			Public.ajaxPost(rootPath+"/ordermanager/putinstoragemanager/viewPutInStorageHistory.json",{id:id}, function(json){
				if(json.status==200){
