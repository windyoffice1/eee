var url=rootPath+"/reportforms/purchase",gridQryUrl=url+"/purchaseReportFormsByCustomer.json",custParame=SYSTEM.custParame,typeList=custParame.typeList;
var model = avalon.define({$id:'view',user:SYSTEM.user,parameList:typeList,
	...
	resetQry:function(){
		...
		model.query={start_date:date,end_date:SYSTEM.endDate,material_type_id:"",customer_id:'',customer_name:'',material_data_no:'',material_data_name:'',
		    	matrial_broad_id:"",matrial_broad_name:"",};
		model.loadData();
	},
	queryAll:function(){
