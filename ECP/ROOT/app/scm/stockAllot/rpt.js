var url=rootPath+"/scm/stockAllot",gridQryUrl=url+"/rptList.json";
var model = avalon.define({$id:'view',user:SYSTEM.user,
    query :{start_date:SYSTEM.beginDate,end_date:SYSTEM.endDate,to_depot_id:'',out_depot_id:'',product_id:'',product_name:'',head_id:"",head_name:""},
