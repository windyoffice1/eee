...
var model = avalon.define({$id:'view',
	data:{remark:"",address: "",amt: 0,city: "",email: "",ent_cate: "",ent_stage: "",fax: "",head_id: "",head_name: "",id: "",industry: "",integral: 0,is_deleted: 0,member_card: "",mobile: "",name: "",origin: "",ownership: "",province: "",province_name: "",rating: "",remark: "",sn: "",staff_size: "",status: 0,telephone: "",type: 1,year_turnover: "",zip_code: ""},
	//首要联系人
	...
	initDom : function() {
		if(id!=undefined&&id!=''&&id!='undefined'){
			Public.ajaxPost(url+"/qryOp.json",{id:id}, function(json){
				if(json.status==200){
					console.info(json.data.customer);
...
function postData(){
	...
	parent.parent.Public.tips({type:1,content:"联系人姓："+model.contacts.name});
	console.info(model);
